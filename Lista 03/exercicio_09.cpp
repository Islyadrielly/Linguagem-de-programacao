/* 9) Elabore um programa que calcule o que deve ser pago por um produto, considerando o preço normal 
de etiqueta e a escolha da condição de pagamento. Utilize os códigos da tabela a seguir para ler qual a 
condição de pagamento escolhida e efetuar o cálculo adequado.Código Condição de pagamento:
...
int main() {
    ...
    cout << "\t(1) - A vista" << endl; //o /t da tab
...
system("pause"); // utilizo isso para pausar o cmd.
return 0;
